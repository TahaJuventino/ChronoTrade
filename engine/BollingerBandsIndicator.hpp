...
namespace engine {
    ...
    public:
        ...
        // Debug/Introspection
        double get_sma() const { return sma; }
        double get_upper_band() const { return upper; }
        double get_lower_band() const { return lower; }
        double get_band_width() const { return upper - lower; }
        double get_stddev() const { return stddev; }
        double get_band_distance() const;
        std::optional<std::string> get_last_signal() const { return lastSignal; }
